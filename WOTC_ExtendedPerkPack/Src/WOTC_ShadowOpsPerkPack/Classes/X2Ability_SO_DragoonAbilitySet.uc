...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(Charge()); // TODO test
	Templates.AddItem(Rocketeer());
	Templates.AddItem(EatThis()); // TODO test
	...
	Templates.AddItem(Overkill()); // TODO test
...
// TODO X2AbilityTemplate_Dragoon isn't working properly, use X2AbilityTemplate for now, even though it won't add armor to the armory ui
...
// TODO X2AbilityTemplate_Dragoon isn't working properly, use X2AbilityTemplate for now, even though it won't add bonus stats to the armory ui
